    ...
    <section style={{ minHeight:'90vh', display:'flex', alignItems:'center', padding:'60px 32px', gap:40, flexWrap:'wrap' }}>
      ...
      <div style={{ flex:1, minWidth:300, display:'flex', justifyContent:'center' }}>
        <div style={{ width:340, height:340, borderRadius:'32px', background:'linear-gradient(135deg,#7C3AED22,#06B6D422)', border:'2px solid #7C3AED30', display:'flex', alignItems:'center', justifyContent:'center', position:'relative', overflow:'hidden' }}>
          ...
          {/* Step 1: Upload your photo as public/profile.jpg */}
          {/* Step 2: Uncomment the img tag below and delete the placeholder div */}
          
          {/* <img src="/profile.jpg" alt="Vidyullatha" style={{ width:'100%', height:'100%', objectFit:'cover', borderRadius:'32px', position:'relative', zIndex:1 }} /> */}
          
          <div style={{ textAlign:'center', position:'relative', zIndex:1 }}>
            <div style={{ width:80, height:80, borderRadius:'50%', background:'linear-gradient(135deg,#7C3AED,#06B6D4)', margin:'0 auto 12px', display:'flex', alignItems:'center', justifyContent:'center', fontSize:32, color:'white' }}>VP</div>
            <span style={{ color:'#7C3AED', fontWeight:600, fontSize:14 }}>Add your photo<br/>as public/profile.jpg</span>
          </div>
        </div>
      </div>
    </section>
